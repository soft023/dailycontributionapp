...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">My Corperative</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
              <img src="companylogo/{{session('logo')}}" class="user-image img-responsive"/>
    ...
    <!-- Sidebar Menu -->
      <nav class="mt-2">
          ...
          <li class="nav-item">
          <a href="/backend/newcompanyform" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>New</p>
          </a>
          </li>
          <li class="nav-item">
          <a href="/backend/allcompanies" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>All</p>
          </a>
          </li>
...
<div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="#">MYCO-OPERATIVE</a></strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b>1.0/BGMFB IT
    </div>
  </footer>
