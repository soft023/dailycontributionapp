...
<div class="col-lg-8 col-md-8 col-sm-12 col-xm-12 text-center w3-text-purple">
 ...
 <h6>Please be informed that by completing this form and accepting our terms & conditions, you have given BGMFB an instruction to transfer your loan sum (net of charges) to your Salary Account or to Pay you in person.
</h6>
</div>
...
<form method="POST" action="/submitfederaldata" enctype="multipart/form-data">
@csrf
...
<option value="{{$data['tenure']}}"  selected>{{$data['tenure']}}</option>  
